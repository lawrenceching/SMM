...
- [x] `docs/superpowers/design/media-file-table-compress-transcode-context-menu/context.md` — 上下文分析
- [x] `docs/superpowers/design/media-file-table-compress-transcode-context-menu/design.md` — 本设计文档
