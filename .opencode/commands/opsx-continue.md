...
1. **If no change name provided, prompt for selection**
   ...
   Present the top 3-4 most recently modified changes as options, showing: Change name, Schema (from `schema` field if present, otherwise "spec-driven"), Status (e.g., "0/5 tasks", "complete", "no tasks"), How recently it was modified (from `lastModified` field).
...
- **IMPORTANT**: `context` and `rules` are constraints for YOU, not content for the file. Do NOT copy them into the artifact.
