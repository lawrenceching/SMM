...
Define transcribe entry points for **TvShowPanel** and **MoviePanel**: header control, **`TranscribeDialog`** filled from **`MediaMetadata.mediaFiles`**, and gating when VideoCaptioner is unavailable.
