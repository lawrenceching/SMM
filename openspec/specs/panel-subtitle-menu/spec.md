...
Define the **Subtitle** parent control and menus in **TvShow**, **Movie**, and **Music** panel headers and in **`MusicFileTable`** row context menus, including **Transcribe**, **Translate**, and **Synthesize** items and gating.
