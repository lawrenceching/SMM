...
The Request Tracing capability defines how the system generates, propagates, and maintains trace identifiers throughout the request lifecycle for end-to-end request correlation and debugging.
