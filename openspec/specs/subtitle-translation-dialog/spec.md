...
Define **`SubtitleTranslationDialog`**: row derivation from TV / movie / music panels, translator and target language UX, confirmation enqueue semantics, and gating when VideoCaptioner is unavailable.
