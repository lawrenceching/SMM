...
- [ ] 3.4 Create unit tests for `getMediaMetadataTool` handler
- [ ] 3.5 Create unit tests for `writeMediaMetadataTool` handler
- [ ] 3.6 Create unit tests for `deleteMediaMetadataTool` handler
...
- [ ] 4.3 Create unit tests for `getEpisodesTool` handler
- [ ] 4.4 Create unit tests for `getApplicationContextTool` handler
...
- [ ] 5.5 Create unit tests for `renameFolderTool` handler
- [ ] 5.6 Create unit tests for rename batch task handlers
...
- [ ] 6.4 Create unit tests for recognize task handlers
...
- [ ] 8.1 Test MCP server starts with all tools registered
- [ ] 8.2 Test tool discovery via MCP protocol
- [ ] 8.3 Test file operation tools with real file system
- [ ] 8.4 Test metadata tools with real metadata cache
- [ ] 8.5 Test batch operation task lifecycle

## 9. Documentation

- [ ] 9.1 Update `cli/docs/MCP.md` with new tool documentation
- [ ] 9.2 Add tool descriptions and parameters to each tool handler file
- [ ] 9.3 Create example usage documentation for complex tools (batch operations)

## 10. Verification

- [ ] 10.1 Run all unit tests and ensure pass
- [ ] 10.2 Verify all tools are registered correctly
- [ ] 10.3 Test end-to-end with MCP client
- [ ] 10.4 Verify implementation matches specifications
