...
- [ ] 4.1 Test menu item appears and is clickable
- [ ] 4.2 Test folder selection dialog opens correctly in Electron environment
- [ ] 4.3 Test folder selection dialog opens correctly in web environment
- [ ] 4.4 Test folder type selection dialog opens after library folder selection
- [ ] 4.5 Test all subfolders are enumerated correctly
- [ ] 4.6 Test each subfolder is imported sequentially
- [ ] 4.7 Test already-imported folders are skipped gracefully
- [ ] 4.8 Test error handling when a folder fails to import (continues with remaining folders)
- [ ] 4.9 Test with empty media library directory
- [ ] 4.10 Test with library containing mixed folder types (verify all get same selected type)
