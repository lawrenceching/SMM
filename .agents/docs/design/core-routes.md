...
| POST | `/api/deleteFile` | `handleDeleteFilePost` |
| GET | `/api/image` | `handleDownloadImageGet` |
| POST | `/api/downloadImage` | `handleDownloadImageAsFilePost` |
| POST | `/api/readImage` | `handleReadImagePost` |
