...
function renderLayout(
  ...
  return render(<MediaFileTablePreviewLayout {...baseProps} />)
}

/** Preview rows show "SxxExx · title" in one cell (no dedicated ID column). */
function getEpisodeRow(idPrefix: string): HTMLTableRowElement {
  const cell = screen.getByText(new RegExp(`^${idPrefix}\\b`))
...
describe("MediaFileTablePreviewLayout", () => {
