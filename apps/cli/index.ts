...
const cliCommands = new Set(['list', 'add', 'show', 'metadata', 'rm', 'config', 'try-to-recognize', 'try-to-rename', 'apply', 'scrape', 'job', 'rename', 'rename-episode-file', 'hello', 'tmdb', 'tvdb', 'mcp'])
