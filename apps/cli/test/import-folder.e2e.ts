...
describe('smm import folder CLI e2e', () => {
  ...
  beforeEach(() => {
    ...
    userDataDir = mkdtempSync(join(tmpdir(), 'smm-cli-import-folder-e2e-ud-'))
    mediaDir = mkdtempSync(join(tmpdir(), 'smm-cli-import-folder-e2e-media-'))
